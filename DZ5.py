...
data = '22.09.2022'
d, m, y = data.split('.')  # объявляем переменную d, m, y и используя ф-ю split разделяем строку через ' . '

print(d, m, y)             # вывод 22 09 2022 дата состоит из трех частей
# далее необходимо преобразовать строку в текстовый вид

month = {                  # объявляем словарь month, который будет хранить информацию о месецах
    '01': 'января',
    '02': 'февраля',
    '03': 'марта',
    '04': 'апреля',
